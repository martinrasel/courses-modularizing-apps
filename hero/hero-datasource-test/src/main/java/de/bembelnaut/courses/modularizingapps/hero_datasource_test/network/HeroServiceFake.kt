...
import de.bembelnaut.courses.modularizingapps.hero_datasource.network.HeroServiceImpl
import de.bembelnaut.courses.modularizingapps.hero_datasource_test.network.data.HeroDataEmpty
import de.bembelnaut.courses.modularizingapps.hero_datasource_test.network.data.HeroDataMalformed
                ...
                install(JsonFeature) {
                    serializer = KotlinxSerializer(
                        kotlinx.serialization.json.Json {
                            ignoreUnknownKeys =
                                true // if the server sends extra filds, ignore them
                        }
                    )
                }
                engine {

...
fun getHeroAttrFromUiValue(uiValue: String) =
    when (uiValue) {
...
fun getHeroAttrFromAbbreviation(abbreviation: String) =
    when (abbreviation) {
...
fun Hero.minAttackDmg() =
    when (primaryAttribute) {
